...
$a->strings['Welcome home %s.'] = 'Bem-vind@ à sua página pessoal %s.';
...
$a->strings['Welcome to %s'] = 'Bem-vind@ à %s';
...
$a->strings['You receive a friend suggestion'] = 'Você recebe uma sugestão de amigo';
...
$a->strings['Account Types'] = 'Tipos de conta';
$a->strings['All'] = 'Todos';
$a->strings['Persons'] = 'Pessoas';
$a->strings['Organisations'] = 'Organizações';
$a->strings['Latest Activity'] = 'Últimas Atividades';
$a->strings['Latest Posts'] = 'Últimas Postagens';
$a->strings['Scheduled Posts'] = 'Postagens agendadas';
$a->strings['Followers'] = 'Seguidores';
$a->strings['Following'] = 'Segue';
$a->strings['Mutual friends'] = 'Amizade mútua';
$a->strings['Everyone'] = 'Todos';
$a->strings['Pending'] = 'Pendente';
$a->strings['Batch Actions'] = 'Ações em Lote'; 
$a->strings['Local Community'] = 'Comunidade Local'; 
$a->strings['Global Community'] = 'Comunidade Global';
$a->strings['More'] = 'Mais';  
$a->strings['Add tag'] = 'Adicionar tag';  
$a->strings['Save to folder'] = 'Salvar na pasta';  
$a->strings['Add star'] = 'Adicionar estrela'; 
$a->strings['Languages'] = 'Línguas'; 
$a->strings['Remove locally'] = 'Remover localmente'; 
$a->strings['Conversations on this and other servers'] = 'Conversas neste e em outros servidores';
$a->strings['Accepting %s as a friend allows %s to subscribe to your posts, and you will also receive updates from them in your news feed.'] = 'Aceitar o %s como amigo permite que ele assine suas postagens, e você também receberá atualizações sobre ele em seu feed de notícias.';
$a->strings['Accepting %s as a subscriber allows them to subscribe to your posts, but you will not receive updates from them in your news feed.'] = 'Aceitar o %s como assinante permite que ele assine suas postagens, mas você não receberá atualizações sobre ele em seu feed de notícias.';
$a->strings['Subscriber'] = 'Assinante';
$a->strings['Show all'] = 'Mostrar todos';
$a->strings['Show unread'] = 'Mostrar não lido';
$a->strings['Allowed characters are a-z, A-Z, 0-9 and special characters except white spaces, accentuated letters and colon (:).'] = 'Os caracteres permitidos são a-z, A-Z, 0-9 e caracteres especiais, exceto espaços em branco, letras acentuadas e dois pontos (:).';
$a->strings['Delete OpenID URL'] = 'Deletar OpenID URL';
$a->strings['Your current password to confirm the changes of the email address'] = 'Sua senha atual para confirmar as alterações do endereço de e-mail';
$a->strings['Set the language we use to show you friendica interface and to send you emails'] = 'Defina o idioma que deseja que a rede social mostre.';
$a->strings['Your Identity Address is <strong>\'%s\'</strong> or \'%s\'.'] = 'Seu endereço de identificação é <strong>\'%s\'</strong> or \'%s\'';
$a->strings['Publish your profile in your local site directory?'] = 'Publicar seu perfil no diretório do site local?';
$a->strings['Your profile will be published in this node\'s <a href="%s">local directory</a>. Your profile details may be publicly visible depending on the system settings.'] = 'Seu perfil será publicado no diretório local deste nó <a href="%s">diretório local</a>. Os detalhes do seu perfil podem ser visíveis publicamente dependendo das configurações do sistema.';
$a->strings['Allow your profile to be searchable globally?'] = 'Permitir que seu perfil seja pesquisável globalmente?';
$a->strings['Activate this setting if you want others to easily find and follow you. Your profile will be searchable on remote systems. This setting also determines whether Friendica will inform search engines that your profile should be indexed or not.'] = 'Ative esta configuração se quiser que outras pessoas o encontrem e sigam facilmente. Seu perfil será pesquisável em sistemas remotos. Essa configuração também determina se o Friendica informará aos mecanismos de pesquisa que seu perfil deve ser indexado ou não.';
$a->strings['Your profile will also be published in the global friendica directories (e.g. <a href="%s">%s</a>).'] = 'Seu perfil também será publicado nos diretórios globais da Friendica (e.g. <a href="%s">%s</a>).';
$a->strings['Hide your contact/friend list from viewers of your profile?'] = 'Ocultar sua lista de contatos/amigos de quem visualizou seu perfil?';
$a->strings['A list of your contacts is displayed on your profile page. Activate this option to disable the display of your contact list.'] = 'Uma lista de seus contatos é exibida em sua página de perfil. Ative esta opção para desativar a exibição de sua lista de contatos.';
$a->strings['Hide your profile details from anonymous viewers?'] = 'Ocultar detalhes do perfil de usuários anônimos?';
$a->strings['Anonymous visitors will only see your profile picture, your display name and the nickname you are using on your profile page. Your public posts and replies will still be accessible by other means.'] = 'Visitantes anônimos verão apenas sua foto de perfil, seu nome de exibição e o apelido que você está usando em sua página de perfil. Suas postagens e respostas públicas ainda poderão ser acessadas por outros meios.';
$a->strings['Make public posts unlisted'] = 'Tornar postagens públicas não listadas';
$a->strings['Your public posts will not appear on the community pages or in search results, nor be sent to relay servers. However they can still appear on public feeds on remote servers.'] = 'Suas postagens públicas não aparecerão nas páginas da comunidade ou nos resultados de pesquisa, nem serão enviadas para servidores de retransmissão. No entanto, eles ainda podem aparecer em feeds públicos em servidores remotos.';
$a->strings['Make all posted pictures accessible'] = 'Tornar todas as fotos postadas acessíveis';
$a->strings['This option makes every posted picture accessible via the direct link. This is a workaround for the problem that most other networks can\'t handle permissions on pictures. Non public pictures still won\'t be visible for the public on your photo albums though.'] = 'Esta opção torna todas as fotos postadas acessíveis através do link direto. Esta é uma solução para o problema de que a maioria das outras redes não conseguem lidar com permissões em imagens. No entanto, as imagens não públicas ainda não estarão visíveis para o público em seus álbuns de fotos.';
$a->strings['Your contacts may write posts on your profile wall. These posts will be distributed to your contacts'] = 'Seus contatos podem escrever postagens no mural do seu perfil. Essas postagens serão distribuídas para seus contatos';
$a->strings['Your contacts can add additional tags to your posts.'] = 'Seus contatos podem adicionar tags em suas postagens.';
$a->strings['Friendica network users may send you private messages even if they are not in your contact list.'] = 'Os usuários da rede Friendica podem enviar mensagens privadas mesmo que não estejam na sua lista de contatos.';
$a->strings['This content will be shown to all your followers and can be seen in the community pages and by anyone with its link.'] = 'Este conteúdo será mostrado a todos os seus seguidores e poderá ser visto nas páginas da comunidade e por qualquer pessoa com seu link.';
$a->strings['This content will be shown only to the people in the first box, to the exception of the people mentioned in the second box. It won\'t appear anywhere public.'] = 'Este post será mostrado apenas para as pessoas mencionadas na primeira caixa, com exceção das pessoas mencionadas na segunda caixa. Ele não aparecerá em nenhum lugar publicamente.';
$a->strings['Public'] = 'Público';
$a->strings['Limited/Private'] = 'Limitado/Privado';
$a->strings['Show to:'] = 'Mostrar para:';
$a->strings['Except to:'] = 'Exceto para:';
$a->strings['Expiration settings'] = 'Configurações de expiração';
$a->strings['When activated, posts and comments will be expired.'] = 'Quando ativado, as postagens e comentários serão expirados.';
$a->strings['Expire personal notes'] = 'Expirar notas pessoais';
$a->strings['When activated, the personal notes on your profile page will be expired.'] = 'Quando ativado, as notas pessoais em sua página de perfil expirarão.';
$a->strings['Expire starred posts'] = 'Expirar postagens com estrela';
$a->strings['Starring posts keeps them from being expired. That behaviour is overwritten by this setting.'] = 'Marcar publicações com estrela evita que elas expirem. Esse comportamento é substituído por essa configuração.';
$a->strings['Only expire posts by others'] = 'Expirar apenas postagens de outras pessoas';
$a->strings['When activated, your own posts never expire. Then the settings above are only valid for posts you received.'] = 'Quando ativado, suas próprias postagens nunca expiram. Então as configurações acima são válidas apenas para as postagens que você recebeu.';
$a->strings['Create a desktop notification when:'] = 'Crie uma notificação na área de trabalho quando:';
$a->strings['Someone liked your content'] = 'Alguém gostou do seu conteúdo';
$a->strings['Someone shared your content'] = 'Alguém compartilhou seu conteúdo';
$a->strings['Show detailled notifications'] = 'Mostrar notificações detalhadas';
$a->strings['Per default, notifications are condensed to a single notification per item. When enabled every notification is displayed.'] = 'Por padrão, as notificações são condensadas em uma única notificação por item. Quando ativado, todas as notificações são exibidas.';
$a->strings['Show notifications of ignored contacts'] = 'Mostrar notificações de contatos ignorados';
$a->strings['You don\'t see posts from ignored contacts. But you still see their comments. This setting controls if you want to still receive regular notifications that are caused by ignored contacts or not.'] = 'Você não vê postagens de contatos ignorados. Mas você ainda vê seus comentários. Essa configuração controla se você ainda deseja receber notificações regulares causadas por contatos ignorados ou não.';
$a->strings['Activate desktop notifications'] = 'Ativar notificações na área de trabalho';
$a->strings['Show desktop popup on new notifications'] = 'Mostrar pop-up na área de trabalho em novas notificações';
$a->strings['Personal Page'] = 'Página Pessoal';
$a->strings['Account for a personal profile.'] = 'Conta para um perfil pessoal.';
$a->strings['Personal Page Subtypes'] = 'Subtipos de página pessoal';
$a->strings['Account for a regular personal profile that requires manual approval of "Friends" and "Followers".'] = 'Conta para um perfil pessoal regular que requer aprovação manual de "Amigos" e "Seguidores".';
$a->strings['Account for a public profile that automatically approves contact requests as "Followers".'] = 'Conta para um perfil público que aprova automaticamente solicitações de contato como "Seguidores".';
$a->strings['Account for a popular profile that automatically approves contact requests as "Friends".'] = 'Conta para um perfil popular que aprova automaticamente solicitações de contato como "Amigos".';
$a->strings['Organisation Page'] = 'Página de Organização';
$a->strings['Account for an organisation that automatically approves contact requests as "Followers".'] = 'Conta para uma organização que aprova automaticamente solicitações de contato como "Seguidores".';
$a->strings['News Page'] = 'Páginas de Notícias';
$a->strings['Account for a news reflector that automatically approves contact requests as "Followers".'] = 'Conta para um reflector de notícias que aprova automaticamente solicitações de contato como "Seguidores".';
$a->strings['Community Forum'] = 'Fórum da Comunidade';
$a->strings['Account for community discussions.'] = 'Conta para discussões da comunidade.';
$a->strings['Import Contacts'] = 'Importar Contatos';
$a->strings['Upload a CSV file that contains the handle of your followed accounts in the first column you exported from the old account.'] = 'Carregue um arquivo CSV que contenha o identificador de suas contas seguidas na primeira coluna que você exportou da conta antiga.';
$a->strings['Two-factor authentication'] = 'Autenticação Dupla';
$a->strings['<p>Use an application on a mobile device to get two-factor authentication codes when prompted on login.</p>'] = '<p>Use um aplicativo em um dispositivo móvel para obter códigos de autenticação de dois fatores quando solicitado no login.</p>';
$a->strings['Authenticator app'] = 'Aplicativo autenticador'; 
$a->strings['Actions'] = 'Ações';
$a->strings['Current password:'] = 'Senha atual:';
$a->strings['You need to provide your current password to change two-factor authentication settings.'] = 'Você precisa fornecer sua senha atual para alterar as configurações de autenticação dupla.';
$a->strings['Enable two-factor authentication'] = 'Habilitar autenticação dupla';
$a->strings['Disable two-factor authentication'] = 'Desabilitar autenticação dupla';
$a->strings['Display name:'] = 'Nome:';
$a->strings['XMPP (Jabber) address:'] = 'XMPP (Jabber) endereço:';
$a->strings['The XMPP address will be published so that people can follow you there.'] = 'O endereço XMPP será publicado para que as pessoas possam segui-lo.';
$a->strings['Matrix (Element) address:'] = 'Matrix (Element) endereço:';
$a->strings['The Matrix address will be published so that people can follow you there.'] = 'O endereço Matrix será publicado para que as pessoas possam segui-lo.';
$a->strings['Custom Profile Fields'] = 'Campos de Perfil Personalizado';
$a->strings['<p>Custom fields appear on <a href="%s">your profile page</a>.</p>
				<p>You can use BBCodes in the field values.</p>
				<p>Reorder by dragging the field title.</p>
				<p>Empty the label field to remove a custom field.</p>
				<p>Non-public fields can only be seen by the selected Friendica contacts or the Friendica contacts in the selected groups.</p>'] = '<p>Os campos personalizados aparecem em <a href="%s">sua página pessoal</a>.</p>
				<p>Você pode usar BBCodes nos valores do campo.</p>
				<p>Reordenar arrastando o título do campo.</p>
				<p>Esvazie o campo de rótulo para remover um campo personalizado.</p>
				<p>Os campos não públicos só podem ser vistos pelos contatos do Friendica selecionados ou pelos contatos do Friendica nos grupos selecionados.</p>';
$a->strings['Add a new profile field'] = 'Adicionar um novo campo no perfil';
$a->strings['Label:'] = 'Etiqueta:';
$a->strings['Value:'] = 'Valor:';
$a->strings['Field Permissions'] = 'Permissões do campo';
$a->strings['Photo metadata is normally stripped. This extracts the location (if present) prior to stripping metadata and links it to a map.'] = 'Os metadados da foto normalmente são removidos. Isso extrai o local (se houver) antes de remover os metadados e o vincula a um mapa.';
$a->strings['Trending Tags'] = 'Tags de tendência';
$a->strings['Show a community page widget with a list of the most popular tags in recent public posts.'] = 'Mostre um widget de página da comunidade com uma lista das tags mais populares em postagens públicas recentes.';
$a->strings['Add/remove mention when a forum page is selected/deselected in ACL window.'] = 'Adicionar/remover menção quando uma página do fórum é selecionada/desmarcada na janela ACL.';
$a->strings['Explicit Mentions'] = 'Menções explícitas';
$a->strings['Add explicit mentions to comment box for manual control over who gets mentioned in replies.'] = 'Adicione menções explícitas à caixa de comentários para controle manual sobre quem é mencionado nas respostas.';
$a->strings['List Forums'] = 'Listar fóruns';
$a->strings['Show visitors public community forums at the Advanced Profile Page'] = 'Mostrar aos visitantes os fóruns públicos da comunidade na página de perfil avançado.';
$a->strings['Tag Cloud'] = 'Tag cloud';
$a->strings['Provide a personal tag cloud on your profile page'] = 'Forneça uma nuvem de tags pessoais em sua página de perfil.';
$a->strings['Display Membership Date'] = 'Exibir data de associação';
$a->strings['Display membership date in profile'] = 'Exibir data de adesão no perfil.';
$a->strings['General Theme Settings'] = 'Configuração de Temas';
$a->strings['Custom Theme Settings'] = 'Configuração de Temas Personalizados';
$a->strings['Select color scheme'] = 'Selecione esquema de cores';
$a->strings['Content background opacity'] = 'Opacidade do plano de fundo';
$a->strings['Content Settings'] = 'Configuração de Conteúdo';
$a->strings['Automatic updates only at the top of the post stream pages'] = 'Atualizações automáticas apenas na parte superior das páginas de fluxo de postagem';
$a->strings['Auto update may add new posts at the top of the post stream pages, which can affect the scroll position and perturb normal reading if it happens anywhere else the top of the page.'] = 'A atualização automática pode adicionar novas postagens na parte superior das páginas de fluxo de postagem, o que pode afetar a posição de rolagem e perturbar a leitura normal se ocorrer em qualquer outro lugar na parte superior da página.';
$a->strings['Display emoticons'] = 'Exibir emoticons';
$a->strings['When enabled, emoticons are replaced with matching symbols.'] = 'Quando ativado, os emoticons são substituídos por símbolos correspondentes.';
$a->strings['Automatic fetch new items when reaching the page end.'] = 'Busca automática de novos itens ao chegar ao final da página.';
$a->strings['Enable Smart Threading'] = 'Ativar Encadeamento Inteligente';
$a->strings['Enable the automatic suppression of extraneous thread indentation.'] = 'Habilite a supressão automática de indentação estranha.';
$a->strings['Display the Dislike feature'] = 'Exibir o Recurso Não Gostei';
$a->strings['Display the Dislike button and dislike reactions on posts and comments.'] = 'Exiba o botão "não gostei" em reações de postagens e comentários.';
$a->strings['Display the resharer'] = 'Exibir o compartilhador';
$a->strings['Display the first resharer as icon and text on a reshared item.'] = 'Exiba o primeiro compartilhador como ícone e texto em um item compartilhado novamente.';
$a->strings['Stay local'] = 'Mantenha-se local';
$a->strings['Don\'t go to a remote system when following a contact link.'] = 'Não vá para um sistema remoto ao seguir um link de contato.';
$a->strings['Beginning of week:'] = 'Início da Semana: ';
$a->strings['General Social Media Settings'] = 'Configurações Gerais de Mídia Social';
$a->strings['Accept only top level posts by contacts you follow'] = 'Aceite apenas postagens de nível superior de contatos que você segue';
$a->strings['The system does an auto completion of threads when a comment arrives. This has got the side effect that you can receive posts that had been started by a non-follower but had been commented by someone you follow. This setting deactivates this behaviour. When activated, you strictly only will receive posts from people you really do follow.'] = 'O sistema conclui automaticamente os tópicos quando chega um comentário. Isso tem um efeito colateral de que você pode receber postagens iniciadas por alguém que você não segue, porque um de seus seguidores comentou lá. Essa configuração desativará esse comportamento. Se ativado, você só receberá postagens de pessoas que você realmente segue.';
$a->strings['Enable Content Warning'] = 'Ativar aviso de conteúdo';
$a->strings['Users on networks like Mastodon or Pleroma are able to set a content warning field which collapse their post by default. This enables the automatic collapsing instead of setting the content warning as the post title. Doesn\'t affect any other content filtering you eventually set up.'] = 'Usuários em redes como Mastodon ou Pleroma podem definir um campo de aviso de conteúdo que recolhe sua postagem por padrão. Isso permite o recolhimento automático em vez de definir o aviso de conteúdo como o título do post. Não afeta nenhum outro filtro de conteúdo que você eventualmente configurou.';
$a->strings['Enable intelligent shortening'] = 'Ative o encurtamento inteligente';
$a->strings['Normally the system tries to find the best link to add to shortened posts. If disabled, every shortened post will always point to the original friendica post.'] = 'Normalmente o sistema tenta encontrar o melhor link para adicionar aos posts encurtados. Se desabilitado, todo post encurtado sempre apontará para o post original do friendica.';
$a->strings['Enable simple text shortening'] = 'Ativar encurtamento de texto simples';
$a->strings['Normally the system shortens posts at the next line feed. If this option is enabled then the system will shorten the text at the maximum character limit.'] = 'Normalmente, o sistema encurta os posts no próximo avanço de linha. Se esta opção estiver habilitada, o sistema encurtará o texto no limite máximo de caracteres.';
$a->strings['Attach the link title'] = 'Anexe o título do link';
$a->strings['When activated, the title of the attached link will be added as a title on posts to Diaspora. This is mostly helpful with "remote-self" contacts that share feed content.'] = 'Quando ativado, o título do link anexado será adicionado como título nas postagens do Diaspora. Isso é útil principalmente com contatos "remotos" que compartilham conteúdo de feed.';
$a->strings['Your legacy ActivityPub/GNU Social account'] = 'Sua conta legada do ActivityPub/GNU Social';
$a->strings['If you enter your old account name from an ActivityPub based system or your GNU Social/Statusnet account name here (in the format user@domain.tld), your contacts will be added automatically. The field will be emptied when done.'] = 'Se você inserir seu nome de conta antigo de um sistema baseado em ActivityPub ou seu nome de conta GNU Social/Statusnet (no formato user@domain.tld), seus contatos serão adicionados automaticamente. O campo será esvaziado quando terminar.';
$a->strings['Repair OStatus subscriptions'] = 'Reparar assinaturas do OStatus';
$a->strings['Addon Settings'] = 'Configuração dos Addons';
$a->strings['Manage Accounts'] = 'Gerenciar Contas';
$a->strings['Additional Accounts'] = 'Contas Adicionais';
$a->strings['Register additional accounts that are automatically connected to your existing account so you can manage them from this account.'] = 'Registre contas adicionais que são conectadas automaticamente à sua conta existente para que você possa gerenciá-las a partir desta conta.';
$a->strings['Register an additional account'] = 'Registre uma conta adicional';
$a->strings['Parent User'] = 'Usuário Pai';
$a->strings['Parent users have total control about this account, including the account settings. Please double check whom you give this access.'] = 'Os usuários pais têm controle total sobre esta conta, incluindo as configurações da conta. Verifique novamente a quem você concede esse acesso.';
$a->strings['Parent Password:'] = 'Senha do Usuário pai:';
$a->strings['Please enter the password of the parent account to legitimize your request.'] = 'Digite a senha da conta pai para legitimar sua solicitação.';
$a->strings['Delegates'] = 'Delegados';
$a->strings['Export your account info, contacts and all your items as json. Could be a very big file, and could take a lot of time. Use this to make a full backup of your account (photos are not exported)'] = 'Exporte as informações da sua conta, contatos e todos os seus itens para um arquivo json. O processo pode levar um tempo, pois o arquivo pode ser muito grande. Use isso para fazer um backup completo da sua conta (as fotos não são exportadas)';
$a->strings['Export Contacts to CSV'] = 'Exportar contatos para CSV';
$a->strings['Export the list of the accounts you are following as CSV file. Compatible to e.g. Mastodon.'] = 'Exporte a lista das contas que você está seguindo como arquivo CSV.';
$a->strings['Login failed. Please check your credentials.'] = 'Falha no login. Por favor, verique suas credenciais.';
$a->strings['Your Full Name (e.g. Joe Smith, real or real-looking): '] = 'Seu nome completo: ';
$a->strings['Your Email Address: (Initial information will be send there, so this has to be an existing address.)'] = 'Seu endereço de e-mail: (As informações iniciais serão enviadas para lá, portanto, este deve ser um endereço existente.)';
$a->strings['Please repeat your e-mail address:'] = 'Por favor, repita o seu endereço de e-mail:';
$a->strings['Choose a profile nickname. This must begin with a text character. Your profile address on this site will then be "<strong>nickname@%s</strong>".'] = 'Escolha um apelido de perfil. Isso deve começar com um caractere de texto. Seu endereço de perfil neste site será então "<strong>nickname@%s</strong>".';
...
$a->strings['Delete globally'] = 'Deletar';
$a->strings['Ignore thread'] = 'Ignorar';
$a->strings['Community Forum Subtypes'] = 'Subtipos do fórum da comunidade';
$a->strings['Public Forum'] = 'Fórum Público';
$a->strings['Automatically approves all contact requests.'] = 'Aprova automaticamente todas as solicitações de contato.';
$a->strings['Requires manual approval of contact requests.'] = 'Requer aprovação manual de solicitações de contato.';
$a->strings['%1$s shared the post %2$s from %3$s'] = '%1$s compartilhou a postagem %2$s de %3$s';
$a->strings['
				Dear %1$s,
				Thank you for registering at %2$s. Your account has been created.
			'] = '
				Olá %1$s,
				Obrigado por se cadastrar na %2$s. Sua conta foi criada.
			';
			$a->strings['
			...
			Segue abaixo as informações para efetuar o login:

			Endereço do Site: %3$s
			Usuário: %1$s
			Senha: %5$s
			
			Após o login, você deve alterar sua senha na página "Configurações" da sua conta.

			Reserve alguns minutos para revisar as outras configurações da conta nessa página.

			Você também pode adicionar algumas informações básicas ao seu perfil padrão
			(na página "Perfis") para que outras pessoas possam encontrá-lo facilmente.
			
			Recomendamos que você defina seu nome completo, adicione uma foto de perfil e 
			também algumas "palavras-chave" de perfil (muito úteis para fazer novos amigos).

			Seja bem-vind@ à %2$s.';

$a->strings['thanks'] = 'Obrigado';
$a->strings['%s Administrator'] = 'Administrador da %s';
$a->strings['Your nickname can only contain a-z, 0-9 and _.'] = 'O usuário pode conter apenas: a-z, 0-9 e _.';
$a->strings['
		Dear %1$s,
		...
		Caro %1$s,
			...
			Recentemente, uma solicitação foi recebida em "%2$s" para redefinir sua 
		senha. Para confirmar esta solicitação, selecione o link de verificação abaixo 
		ou cole-o na barra de endereços do seu navegador.

		Se você NÃO solicitou essa alteração, NÃO siga o link fornecido e ignore e/ou 
		exclua este e-mail, a solicitação expirará em breve.'
;
$a->strings['
		...
		Site Location:	%2$s
		Login Name:	%3$s'] = '
		Acesse o link abaixo para visualizar sua nova senha:

		%1$s
			
		Após o login, você pode alterar a senha na página de configurações da sua conta.

		Os detalhes de login são os seguintes:
			
		Endereço: %2$s
		Usuário: %3$s';
$a->strings['Shall your connection be bidirectional or not?'] = 'Deseja que sua conexão seja de que forma?';
$a->strings['Notification type:'] = 'Tipo de notificação:';
$a->strings['Welcome %s'] = 'Seja bem-vind@ %s!';
$a->strings['%1$s shared the post %2$s'] = '%1$s compartilhou a postagem %2$s';
$a->strings['Show more'] = 'Mostrar mais';
$a->strings['Show fewer'] = 'Mostrar menos';
$a->strings['Pending outgoing contact request'] = 'Solicitação de contato pendente';
$a->strings['Pending incoming contact request'] = 'Solicitação de contato pendente';
$a->strings['%d year old'] = [
	0 => '%d ano',
	1 => '%d anos',
];
$a->strings['Yourself'] = 'Você mesmo';
$a->strings['View profile as:'] = 'Ver perfil como:';
$a->strings['Cancel'] = 'Cancelar';
$a->strings['View'] = 'Visualizar';
$a->strings['list'] = 'lista';
$a->strings['Profile Actions'] = 'Ações de Perfil';
$a->strings['Contact Settings'] = 'Configurações do Contato';
$a->strings['Refetch contact data'] = 'Recuperar dados do contato';
$a->strings['Contact (%s)'] = [
	0 => 'Contato (%s)',
	1 => 'Contatos (%s)',
];
...
$a->strings['All contacts'] = 'Todos contatos';
$a->strings['Common'] = 'Comum';
$a->strings['Common contact (%s)'] = [
	0 => 'Contato comum (%s)',
	1 => 'Contatos comuns (%s)',
];
$a->strings['Both <strong>%s</strong> and yourself have publicly interacted with these contacts (follow, comment or likes on public posts).'] = 'Tanto <strong>%s</strong> quanto você interagiram publicamente com esses contatos (seguir, comentar ou curtir em postagens públicas).';
$a->strings['These contacts both follow and are followed by <strong>%s</strong>.'] = 'Esses contatos seguem e são seguidos por <strong>%s</strong>.';
$a->strings['Terms of Service'] = 'Termos de Uso e Política de Privacidade';
$a->strings['Privacy Statement'] = 'Declaração de Privacidade';
$a->strings['Password unchanged.'] = 'Senha não alterada.';
$a->strings['The new password has been exposed in a public data dump, please choose another.'] = 'A nova senha foi exposta em um despejo de dados público, escolha outra.';
$a->strings['Passwords do not match.'] = 'As senhas não coincidem.';
$a->strings['%1$s replied to you on %2$s'] = '%1$s respondeu você em %2$s';
$a->strings['%1$s tagged you on %2$s'] = '%1$s marcou você em %2$s';
$a->strings['%1$s commented in the thread %2$s from %3$s'] = '%1$s comentou a postagem %2$s de %3$s';
$a->strings['%1$s commented in their thread %2$s'] = '%1$s comentou sua postagem %2$s';
$a->strings['%1$s commented in their thread'] = '%1$s comentou sua postagem';
$a->strings['%1$s commented in the thread from %3$s'] = '%1$s comentou uma postagem de %3$s';
$a->strings['%s attends.'] = '%s confirmou presença.';
$a->strings['%s attend.'] = '%s confirmou presença.';
$a->strings['%s doesn\'t attend.'] = '%s confirmou ausência.';
$a->strings['%s attends maybe.'] = '%s talvez compareça.';
